...
if __name__ == '__main__':
    ...
    # Create model
    # model = CNN3D(img_depth=img_d, img_height=img_h, img_width=img_w, num_classes=num_classes).to(device)
    ...
    for epoch in range(epochs):
        ...
        # Save model
        torch.save(model.state_dict(), os.path.join(model_path, "slr_lstm_epoch{}.pth".format(epoch+1)))
